...
public class FeedProvider extends ContentProvider {
    ...
    synchronized public Cursor query(@NonNull final Uri uri, final String[] projection,
        ...
        case SINGLE_ENTRY_ROW:
            if (selection==null){
                ...
                modifiedSelection += " AND " + uri .getLastPathSegment();
            }
        ...
        // TODO - you fill in here replacing this statement with your solution.
            query(mDB, projection, updatedsortOrder);
    }}
    ...
    synchronized private Cursor query(final Uri uri, final String tableName,
        ...
        // TODO - you fill in here.
mDB.query(tableName, projection, selection, selectionArgs, sortOrder);
        

        // return the builder.query(....) result, after passing the appropriate values.
        // TODO - you fill in here replacing the following statement with your solution.
            return builder.query(builder, projection, sortOrder);
    ...
    synchronized public Uri insert(@NonNull Uri uri, ContentValues assignedValues) {
        ...
        default:
        throw new IllegalArgumentException("\"Unsupported URI, unable to insert into specific row: \"\n" +
                "            //        + uri");
    }}
    ...
    synchronized public int delete(@NonNull Uri uri,
        ...
        switch (uriMatch) {
            ...
            case SINGLE_ENTRY_ROW:
                if (whereClause==null)
                    modifiedWhereClause="_ID = last path segment";
                else{
                    modifiedWhereClause.append("AND"+"_ID = last path segment");}
            ...
            // TODO - you fill in here.
            case ALL_ENTRY_ROWS:
                deleteAndNotify(uri, modifiedWhereClause, whereClause, whereArgs);
    ...
    private int deleteAndNotify(final Uri uri, final String tableName,
        ...
        // TODO - you fill in here.
        FeedDBAdapter.delete(uri, whereClause, whereArgs);
    ...
    synchronized public int update(@NonNull Uri uri,
        ...
        // TODO - you fill in here.
        ContentValues values.remove("_ID");
